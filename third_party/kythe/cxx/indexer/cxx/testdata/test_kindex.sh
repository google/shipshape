...
CAMPFIRE_ROOT=${PWD}
BASEDIR="${CAMPFIRE_ROOT}/third_party/kythe/cxx/indexer/cxx/testdata"
VERIFIER="${CAMPFIRE_ROOT}/campfire-out/bin/third_party/kythe/cxx/verifier/verifier"
INDEXER="${CAMPFIRE_ROOT}/campfire-out/bin/third_party/kythe/cxx/indexer/cxx/indexer"
KINDEX_TOOL="${CAMPFIRE_ROOT}/campfire-out/bin/third_party/kythe/cxx/tools/kindex_tool"
TEST_TEMP="${CAMPFIRE_ROOT}/campfire-out/test/third_party/kythe/cxx/indexer/cxx/testdata"
