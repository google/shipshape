...
type ReportApiColumnSpec struct {
	...
	// CustomMetricName: Reports on the provided custom metric. The report
	// must be scoped to an advertiser or lower, and the custom metric must
	// already be set up in DoubleClick Search. The custom metric name,
