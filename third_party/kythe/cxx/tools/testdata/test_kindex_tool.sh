...
export KINDEX_TOOL_BIN=${CAMPFIRE_ROOT}/campfire-out/bin/third_party/kythe/cxx/tools/kindex_tool
export TEST_DATA=${CAMPFIRE_ROOT}/third_party/kythe/cxx/tools/testdata
export TEST_TEMP=${CAMPFIRE_ROOT}/campfire-out/test/third_party/kythe/cxx/tools/testdata
set -e
mkdir -p ${TEST_TEMP}
